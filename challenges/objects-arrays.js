...
console.log(`A Tyrannosaurus weighs ${tyrannosaurus.weight}.`);

// What was the diet of a velociraptor?
console.log(`Velociraptors are ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`A stegosaurus is ${stegosaurus.length} long!`);
...
zooAnimals.filter((population) => {
  if(population.population < 5) {
    lowerPopulation.push(population.animal_name);
  }
})
